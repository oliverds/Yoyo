        ...
        <div class="flex flex-col gap-16 items-center px-8 w-full max-w-screen-sm md:gap-12 md:px-6">
            <header class="flex flex-col gap-6 items-center px-3 w-full">
                ...
                <div class="flex justify-center gap-4">
                    <a class="border border-neutral-900/10 shadow-md rounded-md py-3 px-6 bg-white hover:bg-neutral-100 text-sm font-semibold text-neutral-900" href="#">
                        Website
                    </a>
                    <a class="border border-neutral-900/10 shadow-md rounded-md py-3 px-6 bg-white hover:bg-neutral-100 text-sm font-semibold text-neutral-900" href="#">
                        Email
            ...
            <div class="w-full flex flex-col gap-4">
                ...
                <div class="flex w-full justify-between gap-4">
                    <div class="w-full flex justify-center border border-neutral-100 p-3 rounded-md">
